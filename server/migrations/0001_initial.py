    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zip_code', models.TextField(max_length=45, verbose_name='zip code')),
                ...
                ('house_number', models.PositiveIntegerField(help_text='Enter a positive integer for the house number', validators=[django.core.validators.MinValueValidator(1)], verbose_name='house number')),
