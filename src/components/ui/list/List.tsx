...
import { FC, forwardRef, Fragment, PropsWithChildren, ReactNode } from "react";
...
export const List = forwardRef<HTMLUListElement, ListProps>(({items, mapItems, className}, ref) => {
    return (
